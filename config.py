...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8957819603:AAG9Yq9yh6JcOWV1vh-vrhHswrJaxKxPg7o")
...
FORCE_MSG = os.environ.get(
    "FORCE_SUB_MESSAGE",
    "<b>Hello👋 {first}</b>\n\n"
    "<b>You must join the following channel(s) to use this bot.\n"
    "Click the button(s) below, then press ♻️ Try Again ♻️</b>"
)
